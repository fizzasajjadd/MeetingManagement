<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewMeetingsDept.aspx.cs" Inherits="WebApplication10.viewMeetingsDept" %>
...
<section data-bs-version="5.1" class="features10 cid-t79Qg8bjsL" id="features11-c">
    ...
    <div class="container">
        ...
        <section class="searchbydept">
               <div style="margin-left: auto; margin-right: auto; text-align: center;">
					<form id="formsearchbydept" runat="server">
						<h4>Enter Department Name:
						<asp:TextBox ID="searchbydept" placeholder="Department Name" runat="server" ></asp:TextBox>
                      
                        <asp:Button  ID="ButtonSearchbydept" runat="server" BackColor ="lightblue" class="submit" Text="Search" Height="33px" Width="92px" OnClick="ButtonSearchbydept_Click1"/>
