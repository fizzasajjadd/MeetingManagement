<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScheduleMeeting.aspx.cs" Inherits="WebApplication10.ScheduleMeetingaspx" %>
...
<section data-bs-version="5.1" class="form7 cid-t6JJC1Lk2N" id="form7-8">
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Schedule a Meeting</strong></h3>
            ...
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    ...
                    <div class="dragArea row">
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <label>Meeting Titile: </label>
                            <asp:TextBox type="text" name="name" placeholder="Meeting Title" data-form-field="name" class="form-control" value="" id="title" runat="server"/>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <label>Description: </label>
                            <asp:TextBox type="desc" name="desc" placeholder="Description" data-form-field="name" class="form-control" value="" id="desc" runat="server"/>
                        </div>
<div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <label>Enter your email: </label>
                            <asp:TextBox type="desc" name="desc" placeholder="Enter your email" data-form-field="name" class="form-control" value="" id="HOST" runat="server"/>
                        </div>
                        <div data-for="phone" class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
                              <label>Meeting Date and Time: </label>
                            <asp:TextBox type="dATEtext" name="date" placeholder="DATE" TextMode="DateTimeLocal"  data-form-field="name" class="form-control" value="" id="DateT" runat="server"/>
                        </div>
			            
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <label>Duration: </label>
                            <asp:TextBox type="duration" name="duration" placeholder="__ hours" data-form-field="name" class="form-control" value="" id="duration" runat="server"/>
                        </div>
                         <div>
                        <label>Choose Department: </label>
                            <asp:RadioButton ID="RadioButton7" runat="server" Text="Social Media"/><br/>
                            <asp:RadioButton ID="RadioButton8" runat="server" Text="Marketing"/><br/>
                            <asp:RadioButton ID="RadioButton9" runat="server" Text="Sales"/><br/>
                    
                            </div>
                        <div>
                        <label>Choose Mode: </label>
                            <asp:Button ID="Button1" runat="server" Text="Online" onClick="Button1_Click"/>
                             <asp:Button ID="Button2" runat="server" Text="Physical" OnClick="Button2_Click" />
                        ...
                        <asp:Panel ID="pnlTextBox" runat="server" Visible="false">
                           <label for="cars">Choose a Venue:</label>
                            <br/>
                            <asp:RadioButton ID="RadioButton1" runat="server" Text="Conference Room"/><br/>
                            <asp:RadioButton ID="RadioButton2" runat="server" Text="Auditorium"/><br/>
                            <asp:RadioButton ID="RadioButton3" runat="server" Text="Office"/><br/>
            
                        </asp:Panel>
                        <asp:Panel ID="Panel1" runat="server" Visible="false">
                           <label for="cars">Choose a Venue:</label>
                        <br/>
                        <asp:RadioButton ID="RadioButton4" runat="server" Text="Google Meet"/><br/>
                            <asp:RadioButton ID="RadioButton5" runat="server" Text="Zoom"/><br/>
                            <asp:RadioButton ID="RadioButton6" runat="server" Text="Skype"/><br/>
                        ...
                        <div class="col-auto mbr-section-btn align-center">
                             <br/><br/>
                            <asp:Button type="submit" class="btn btn-success display-4" Text="Submit" runat="server" OnClick="ScheduleMeeting"/></div>
                    </div>
                </form>
            </div>
        </div>
