<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="searchbydatetime.aspx.cs" Inherits="WebApplication10.searchbydatetime" %>
...
<head runat="server">
  ...
  <title>Home</title>
  <link rel="stylesheet" href="styles/viewMeetings/assets/bootstrap/css/bootstra p.min.css">
            ...
            <section class="searchbydept">
               <div style="margin-left: auto; margin-right: auto; text-align: center;">
					<form id="form2" runat="server">
						<h4>Search Result for <%Response.Write(Session["DateTime"]); %>
