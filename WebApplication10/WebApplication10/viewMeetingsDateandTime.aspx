<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewMeetingsDateandTime.aspx.cs" Inherits="WebApplication10.viewMeetingsDateandTime" %>
    ...
    <div class="container">
        ...
        <section class="searchbydate">
               <div style="margin-left: auto; margin-right: auto; text-align: center;">
					<form id="formsearchbydateandtime" runat="server">
						
                      <h4>Enter Date and Time:
						<asp:TextBox ID="searchbydatetime" placeholder="" TextMode="DateTimeLocal"  runat="server" ></asp:TextBox>
                      
                        <asp:Button  ID="ButtonSearchbydateTime" runat="server" BackColor ="lightblue" class="submit"  Text ="Search" Height="33px" Width="92px" onClick="ButtonSearchbydateTime_Click"/>
					</h4>
                                ...
                                <div class="col-12">
                                    <div class="bottom-line">
                                        ...
                                        <div style="float:right">
                                               <asp:Button ID="details" runat="server" text-color="white" BorderColor="Transparent"  Text="View Details" backColor="lightBlue" Font-Size="15px" Width="140px" Height="30px" CommandArgument='<%# Eval("meeting_ID")%>' OnClick="details_Click" />
                                        </div>
